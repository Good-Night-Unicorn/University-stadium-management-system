  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">高校体育场管理系统注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210113/14ea1e1d7cd3434bb3a25e4f8e7e821c.jpg");
		height: 100vh;
