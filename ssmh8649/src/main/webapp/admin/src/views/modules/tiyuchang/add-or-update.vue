  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.changdibianhao" label="场地编号" prop="changdibianhao">
              <el-input v-model="ruleForm.changdibianhao" 
                placeholder="场地编号" readonly></el-input>
          </el-form-item>
        </div>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.changdijieshao" label="场地介绍" prop="changdijieshao">
                    <span v-html="ruleForm.changdijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tiyuchang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tiyuchangCrossAddOrUpdateFlag = false;
                  this.parent.search();
