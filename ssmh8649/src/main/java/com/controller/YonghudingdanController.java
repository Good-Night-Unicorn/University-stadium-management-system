...
public class YonghudingdanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YonghudingdanEntity yonghudingdan, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			yonghudingdan.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YonghudingdanEntity yonghudingdan, HttpServletRequest request){
    ...
    public R add(@RequestBody YonghudingdanEntity yonghudingdan, HttpServletRequest request){
    	yonghudingdan.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(yonghudingdan);
    	yonghudingdan.setUserid((Long)request.getSession().getAttribute("userId"));
